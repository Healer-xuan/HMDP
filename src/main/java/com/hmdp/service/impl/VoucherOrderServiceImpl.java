...
public class VoucherOrderServiceImpl extends ServiceImpl<VoucherOrderMapper, VoucherOrder> implements IVoucherOrderService {
    ...
    private class VoucherOrderHandler implements Runnable{
        ...
        private void handlePandingList(){
            while(true){
                try {
                    //1.获取Panding-List中的订单信息 XREADGROUP GROUP g1 c1 COUNT 1 STREAMS streams.order 0
                    List<MapRecord<String, Object, Object>> list = stringRedisTemplate.opsForStream().read(
                            Consumer.from("g1", "c1"),
                    ...
                    //2.判断消息获取是否成功
                    if(list == null || list.isEmpty()){
                        //2.1.如果获取失败，说明Panding-List里没有异常消息
                        break;
                    }
                    //3.解析消息中的订单信息
                    MapRecord<String, Object, Object> record = list.get(0);
    ...
    /**
     * 使用Lua脚本＋Redis消息队列解决(Stream)，进一步优化
     * @param voucherId
     * @return
     */
    ...
    public Result seckillVoucher(Long voucherId) {
        ...
        //获取代理对象
        proxy = (IVoucherOrderService) AopContext.currentProxy();//IVoucherOrderService的代理对象
